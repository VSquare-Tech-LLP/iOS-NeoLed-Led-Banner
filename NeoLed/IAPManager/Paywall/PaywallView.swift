...
struct PaywallView: View {
    ...
    var body: some View {
        VStack(spacing:0) {
            ...
            VStack(spacing: isIPad ? ScaleUtility.scaledSpacing(32) : ScaleUtility.scaledSpacing(22)) {
                
                VStack(spacing: isIPad ? ScaleUtility.scaledSpacing(25) : ScaleUtility.scaledSpacing(15)) {
                ...
                VStack(spacing: isIPad ? ScaleUtility.scaledSpacing(32) : ScaleUtility.scaledSpacing(22)) {
                    ...
                    .padding(.horizontal, ScaleUtility.scaledSpacing(10.5))
                    
                    
                    PaywallBottomView(
                        isProcess: purchaseManager.isInProgress,
                        isWeekly: selectedPlan == .weekly ,
                        once: selectedPlan == .lifetime ,
    ...
    func selectPlan(of type: Int) {
        ...
        case 3:
            self.selectedPlan = SubscriptionPlan.gift
        default:
            self.selectedPlan = SubscriptionPlan.yearly
        }
    }
